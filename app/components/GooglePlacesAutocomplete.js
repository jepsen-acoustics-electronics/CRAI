...
export default class GooglePlacesAutocomplete extends Component {
  ...
  getListViewDisplayed = () => this.state.listViewDisplayed || false;
  ...
  _onPress = (rowData) => {
    if (rowData.isEmptyListLabel && this.props.onEmptyListPress) {
      ...
      request.open('GET', 'https://api.noiseandweather.com/proxy/maps/api/place/details/json?' + Qs.stringify({
  ...
  _requestNearby = (latitude, longitude) => {
    ...
    if (latitude !== undefined && longitude !== undefined && latitude !== null && longitude !== null) {
      ...
      if (this.props.nearbyPlacesAPI === 'GoogleReverseGeocoding') {
        ...
        url = 'https://api.noiseandweather.com/proxy/maps/api/geocode/json?' + Qs.stringify({
          latlng: latitude + ',' + longitude,
          key: this.props.query.key,
          ...this.props.GoogleReverseGeocodingQuery,
        });
      } else {
        url = 'https://api.noiseandweather.com/proxy/maps/api/place/nearbysearch/json?' + Qs.stringify({
  ...
  _request = (text) => {
    ...
    if (text.length >= this.props.minLength) {
      ...
      request.open('GET', 'https://api.noiseandweather.com/proxy/maps/api/place/autocomplete/json?&input=' + encodeURIComponent(text) + '&' + Qs.stringify(this.props.query));
      if (this.props.query.origin !== null) {
        request.setRequestHeader('Referer', this.props.query.origin)
      }
      ...
      this.props.onListVisible(false);
    }
  }
  ...
  _onChangeText = (text) => {
    ...
    const val = this._isMounted || this.props.autoFocus;
    this.setState({
      text: text,
      listViewDisplayed: val,
    });
  }
  ...
  _renderRowData = (rowData) => {
    ...
    return (
      ...
      >
        {this._renderListDescription(rowData)}
      </Text>
    );
  }

  _renderListDescription= (rowData) => {
    if (this.props.renderListDescription) {
      return this.props.renderListDescription(rowData);
    }
...
GooglePlacesAutocomplete.propTypes = {
  ...
  renderListDescription: PropTypes.func,
  ...
  onListVisible: PropTypes.func,
  alwaysShowEmpty: PropTypes.bool
}
